      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="mb-20">
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <Award className="hidden sm:flex w-6 h-6 md:w-8 md:h-8 text-primary" />
            <h3 className="text-2xl md:text-3xl font-semibold text-foreground text-center font-[family-name:var(--font-merienda)]">
              Service Excellence
            </h3>
            <Award className="hidden sm:flex w-6 h-6 md:w-8 md:h-8 text-primary scale-x-[-1]" />
            <div className="hidden sm:flex items-center gap-2">
              <div className="w-4 h-4 bg-primary/30 rounded-full"></div>
              <div className="w-3 h-3 bg-primary/60 rounded-full"></div>
              <div className="w-2 h-2 bg-primary rounded-full"></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div className="group relative overflow-hidden shadow-xs bg-background/80 dark:bg-muted/80 backdrop-blur-md border border-border/40 rounded-2xl p-6 transition-all duration-300 cursor-pointer">
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground font-[family-name:var(--font-geist-sans)] py-3">
                  Each cup is carefully brewed using time-honored techniques,
                  ensuring consistent quality and authentic taste that captures
                  the essence of Dubai&apos;s street-style Karak.
                </p>
              </div>
            </div>
            <div className="group relative overflow-hidden shadow-xs bg-background/80 dark:bg-muted/80 backdrop-blur-md border border-border/40 rounded-2xl p-6 transition-all duration-300 cursor-pointer">
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground font-[family-name:var(--font-geist-sans)] py-3">
                  Positioned in high-footfall areas including bustling markets,
                  cultural festivals, and community gatherings to bring
                  authentic Karak directly to our customers.
                </p>
              </div>
            </div>
            <div className="group relative overflow-hidden shadow-xs bg-background/80 dark:bg-muted/80 backdrop-blur-md border border-border/40 rounded-2xl p-6 transition-all duration-300 cursor-pointer">
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground font-[family-name:var(--font-geist-sans)] py-3">
                  More than just tea service - we provide an authentic cultural
                  experience that connects people to Dubai&apos;s rich heritage
                  and the warmth of traditional hospitality.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Brand Promise */}
        <div className="text-center bg-gradient-to-br from-primary/15 via-primary/10 to-primary/15 dark:from-primary/25 dark:via-primary/10 dark:to-primary/25 rounded-3xl p-8 md:p-12">
          <div className="max-w-4xl mx-auto space-y-6">
            <h3 className="text-2xl md:text-3xl font-semibold text-foreground font-[family-name:var(--font-merienda)]">
              Our Promise to You
            </h3>
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed font-[family-name:var(--font-geist-sans)]">
              Every cup of Dubai Karak is crafted with passion, precision, and
              respect for tradition. We promise that{" "}
